...
export const TransactionDetails: React.FC<TransactionDetailsProps> = ({
  ...
  const bgMuted = theme === 'dark' ? 'bg-[#1f1f1f]' : 'bg-slate-50';
  ...
  return (
    <div className={`p-6 md:p-10 space-y-8 pb-32 min-h-screen ${theme === 'dark' ? 'bg-[#1f1f1f]' : 'bg-slate-50'}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-xl border font-medium transition-all duration-200 active:scale-95 ${theme === 'dark'
                ? 'border-[#3a3a3a] text-slate-300 hover:bg-[#2a2a2a] hover:text-white'
